...
export default function Sidebar() {
  ...
  return (
    ...
    <div
      ref={sidebarRef}
      className={`dark:bg-fuchsia-950 bg-fuchsia-300 border-r-2 z-10 dark:border-fuchsia-700 border-fuchsia-500 absolute top-0 left-0 min-h-screen transition-width duration-300 ${
