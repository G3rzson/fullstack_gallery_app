...
export default function PrivacyPage() {
  return (
    <div className="privacy-container">
      ...
      <section>
        <h2 className="section-title">1. Bevezető</h2>
        <p>
      ...
      <section>
        <h2 className="section-title">2. Adatgyűjtés</h2>
      ...
      <section>
        <h2 className="section-title">3. Adatkezelés</h2>
        <ul>
      ...
      <section>
        <h2 className="section-title">4. Sütik</h2>
      ...
      <section>
        <h2 className="section-title">5. Felhasználói jogok</h2>
        <p>
      ...
      <section>
        <h2 className="section-title">6. Biztonság</h2>
        <p>
